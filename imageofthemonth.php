...
<head>
  ...
  <script type="text/javascript" src="js/jquery/jquery.scroll.js">
 </script>
</head>
...
style="color:#ffff80">Image of the Month</span></strong></p>

<p
style="text-align:center;margin-left:auto;margin-right:auto;color:#ffff00"><strong>LEO
by Ian Morison</strong></p>
<img alt="leo" src="imageofthemonth_files/Leo900px.jpg" width="900"
height="625"></div>
</div>
